<div class="media freemesmall" style="margin-bottom:5px; margin-top:5px;">
    ...
    <div class="media-body">
        <h5 class="media-heading text-capitalize mynavitems" style="margin-bottom:5px; margin-top:-3px;" ><a  class="text-decoration-none" href="{{ route('profile.index',['username' => $user->name ])}}">{{$user->getNameOrUsername()}} </a></h5>
        @if ($user->location)
