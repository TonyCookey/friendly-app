        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            ...
            <ul class="nav navbar-nav" style=" font-size:20px;">
                ...
                <li class="nav-item mynavitems active" role="presentation">
                    <a class="nav-link" href="{{route('friend.index')}}">Friends
                        <span class="badge badge-pill badge-light" style="font-size:10px;">{{Auth::user()->friendRequests()->count()}}</span>
                    </a>
                </li>
                @else
                <li class="nav-item mynavitems active" role="presentation">
            ...
            <form class="form-inline" role="search" action="{{route('search.results')}}" style="font-family: 'Itim', cursive;">
                <div class="form-group" style="margin-left:5px;">
                    <i class="fa fa-search" style="color:white; margin-right:8px; "></i>
                    <input class="form-control" type="search" name="query" placeholder="Find People">
                </div>
            ...
            <ul class="nav navbar-nav ml-auto" style="font-size:18px;">
                ...
                <li class="nav-item mynavitems" role="presentation">
                    <a class="btn btn-outline-light action-btn" href="{{route('auth.signup')}}">Sign up</a>
                </li>
            </ul>
            @endif
        </div>
